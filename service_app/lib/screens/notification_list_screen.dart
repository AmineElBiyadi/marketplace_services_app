      ...
      body: StreamBuilder<List<NotificationModel>>(
        ...
        builder: (context, snapshot) {
          if (snapshot.hasError) {
            return Center(child: Text("Erreur de chargement", style: const TextStyle(color: Colors.red)));
          }
    ...
    return Center(
      child: Column(
        ...
        children: [
          ...
          const Text("Aucune notification", style: TextStyle(fontSize: 18, fontWeight: FontWeight.bold, color: Color(0xFF0F172A))),
          const SizedBox(height: 8),
          const Text("Nous vous préviendrons dès qu'il y aura du nouveau.", style: TextStyle(fontSize: 14, color: Color(0xFF64748B))),
        ],
      ),
    );
  }
